  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
            Regulasi dan Peraturan RTH
          </h2>
          <p className="text-lg text-gray-600 text-center mb-8">
            Dasar hukum dan peraturan yang mengatur penyelenggaraan Ruang
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div
              className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
              onClick={() => onNavigate("regulasi-undang-undang")}
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Regulasi tingkat nasional</p>
                </div>
              </div>
              <div className="inline-flex items-center text-blue-600 font-medium">
                Lihat Semua Undang-Undang
                <svg
                  className="w-4 h-4 ml-1"
                  fill="none"
                  stroke="currentColor"
            ...
            <div
              className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
              onClick={() => onNavigate("regulasi-peraturan-pemerintah")}
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Regulasi tingkat pusat</p>
                </div>
              </div>
              <div className="inline-flex items-center text-green-600 font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
              className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
              onClick={() => onNavigate("regulasi-peraturan-daerah")}
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Regulasi DKI Jakarta</p>
                </div>
              </div>
              <div className="inline-flex items-center text-purple-600 font-medium">
                Lihat Semua Perda
            ...
            {/* Keputusan Gubernur */}
            <div
              className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
              onClick={() => onNavigate("regulasi-keputusan-gubernur")}
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Kebijakan operasional</p>
                </div>
              </div>
