...
const TreePruningApplicationPage = ({ onNavigate }) => {
  ...
  // List of areas in DKI Jakarta for tree pruning
  ...
  const pruningReasons = [
    "Pohon Terlalu Tinggi/Rimbun",
    "Mengganggu Jaringan Listrik",
    "Menghalangi Jalan/Trotoar",
    "Cabang Pohon Rapuh/Berbahaya",
    "Mengganggu Bangunan",
    "Pemeliharaan Rutin",
    "Keamanan Lingkungan",
    "Lainnya",
  ...
  const urgencyLevels = [
    "Sangat Mendesak (1-3 hari)",
    "Mendesak (1 minggu)",
    "Normal (2-4 minggu)",
    "Tidak Mendesak (1-2 bulan)",
  ];
  ...
  const treeTypes = [
    "Pohon Pelindung (Trembesi, Mahoni, dll)",
    "Pohon Buah (Mangga, Jambu, dll)",
    "Pohon Hias (Palem, Pinus, dll)",
    "Pohon Bambu",
    "Tidak Diketahui",
    "Lainnya",
  ];
  ...
  const validateForm = () => {
    ...
    if (!formData.treeLocation.trim())
      newErrors.treeLocation = "Lokasi pohon wajib diisi";
    if (!formData.treeType) newErrors.treeType = "Jenis pohon wajib dipilih";
    if (!formData.treeCount) newErrors.treeCount = "Jumlah pohon wajib diisi";
    if (!formData.pruningReason)
      newErrors.pruningReason = "Alasan pemangkasan wajib dipilih";
    if (!formData.urgencyLevel)
      newErrors.urgencyLevel = "Tingkat urgensi wajib dipilih";
    if (!formData.preferredDate)
      newErrors.preferredDate = "Tanggal yang diinginkan wajib diisi";
    if (!formData.description.trim())
      newErrors.description = "Deskripsi kondisi pohon wajib diisi";
    ...
    if (formData.preferredDate) {
      ...
      if (selectedDate < today) {
        newErrors.preferredDate = "Tanggal harus di masa depan";
      }
    }
    ...
    if (
      formData.treeCount &&
      (isNaN(formData.treeCount) || Number.parseInt(formData.treeCount) < 1)
    ) {
      newErrors.treeCount = "Jumlah pohon harus berupa angka positif";
    }
  ...
  const handleConfirmSubmit = async () => {
    ...
    // Simulate API call
    setTimeout(() => {
      console.log("Tree pruning form submitted:", formData);
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-sm w-full">
          ...
          <div className="p-4">
            <p className="text-gray-700 text-sm mb-3">
              Apakah Anda yakin ingin mengirim permohonan pemangkasan pohon
            ...
            <div className="bg-green-50 rounded-lg p-3 space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="font-medium text-gray-600">Lokasi Pohon:</span>
                <span className="text-gray-800">{formData.treeLocation}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium text-gray-600">Jenis Pohon:</span>
                <span className="text-gray-800">{formData.treeType}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium text-gray-600">Jumlah:</span>
                <span className="text-gray-800">
                  {formData.treeCount} pohon
                </span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium text-gray-600">Alasan:</span>
                <span className="text-gray-800">{formData.pruningReason}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium text-gray-600">Urgensi:</span>
                <span className="text-gray-800">{formData.urgencyLevel}</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-xs text-blue-800">
                  ...
                  <p>
                    Setelah permohonan dikirim, tim akan melakukan survei lokasi
                    dalam 2-3 hari kerja. Pastikan semua informasi sudah benar
                    sebelum mengirim.
                  </p>
                </div>
              </div>
          ...
          <div className="p-6 text-center">
            <div className="mb-4">
              ...
              <p className="text-gray-600 text-sm">
                Permohonan pemangkasan pohon di{" "}
                <strong>{formData.treeLocation}</strong> wilayah{" "}
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left">
                  ...
                  <ul className="text-xs text-blue-700 space-y-1">
                    <li>
                      • Tim survei akan mengunjungi lokasi dalam 2-3 hari kerja
                    </li>
                    <li>
                      • Konfirmasi akan dikirim ke email:{" "}
                      <strong>{formData.email}</strong>
                    </li>
                    <li>• Proses persetujuan memakan waktu 3-7 hari kerja</li>
                    <li>
                      • Anda akan dihubungi untuk koordinasi jadwal pemangkasan
                    </li>
                    <li>
                      • Hubungi:{" "}
            ...
            <div className="bg-white rounded-lg shadow-xl overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-green-600 to-green-700 text-white p-6">
                <h2 className="text-xl font-semibold mb-2">
                  Form Permohonan Pemangkasan Pohon
                </h2>
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1 mt-1">
                                {selectedLocationData.areas.map(
                                  (area, index) => (
                                    <span
                                      key={index}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        placeholder="Contoh: Jl. Sudirman No. 123, depan rumah warna biru"
                      />
                      {errors.treeLocation && (
                        <p className="text-red-500 text-xs mt-1">
                          {errors.treeLocation}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 ${
                          errors.treeType ? "border-red-500" : "border-gray-300"
                        }`}
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Contoh: 5-10 meter (opsional)"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      <select
                        name="pruningReason"
                        value={formData.pruningReason}
                        onChange={handleInputChange}
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 ${
                          errors.pruningReason
                            ? "border-red-500"
                            : "border-gray-300"
                        }`}
                      >
                        <option value="">Pilih alasan pemangkasan</option>
                        {pruningReasons.map((reason) => (
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        placeholder="Jelaskan kondisi pohon dan alasan detail mengapa perlu dipangkas..."
                      />
                      {errors.description && (
                        <p className="text-red-500 text-xs mt-1">
                          {errors.description}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Pagi (07:00-11:00)">
                          Pagi (07:00-11:00)
                        </option>
                        <option value="Siang (11:00-15:00)">
                          Siang (11:00-15:00)
                        </option>
                        <option value="Sore (15:00-17:00)">
                          Sore (15:00-17:00)
                        </option>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                        placeholder="Contoh: Penutupan jalan sementara, pengamanan area, dll. (Kosongkan jika tidak ada)"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                        placeholder="Contoh: Akses crane, pembersihan ranting, dll. (Kosongkan jika tidak ada)"
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-gray-600 mt-1">
                        ...
                        pemangkasan pohon. Saya juga memahami bahwa biaya
                        pemangkasan akan ditanggung sesuai ketentuan yang
                        berlaku.
                      </p>
                      {errors.agreeTerms && (
                        <p className="text-red-500 text-xs mt-1">
...
export default TreePruningApplicationPage;
